...
const ghOrg = "sanjoy0308",
  repoName = "hanacloudui5-app-template",
  branch = "main";
...
(async () => {
  ...
  const octokit = new Octokit({
    userAgent: "generator-hanacloudui5",
  });
  ...
  console.log(
    `Fetching ZIP file for commit ${commitSHA} from @${ghOrg}/${repoName}#${branch}...`
  );
  ...
  if (!fs.existsSync(generatorPath)) {
    console.log(`Extracting templates which was created on Aug 2021...`);
    showBusy(`  Downloading and extracting default templates as of Aug 2021`);
    ...
    console.log("Please be patient. It will take some time. Installing the plugin dependencies...");
